    ...
    <div class="card-body " style="margin: 20px;background: #edf6ff;border: 1px solid #007bff;border-radius:10px;">
        <form id="otp_login" method="POST"style="display: contents;">
            <div class="number_screen"> <label for="phone" class="w-100 text-start form-label">Mobile Number</label>
                ...
                {{-- <div class="number_screen"> <label for="phone" class="w-100 text-start form-label mt-1">Password</label>
            <div class="input-group">
   
               <span class="input-group-text bg-light text-dark">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16"><path d="M18 8H20C20.5523 8 21 8.44772 21 9V21C21 21.5523 20.5523 22 20 22H4C3.44772 22 3 21.5523 3 21V9C3 8.44772 3.44772 8 4 8H6V7C6 3.68629 8.68629 1 12 1C15.3137 1 18 3.68629 18 7V8ZM11 15.7324V18H13V15.7324C13.5978 15.3866 14 14.7403 14 14C14 12.8954 13.1046 12 12 12C10.8954 12 10 12.8954 10 14C10 14.7403 10.4022 15.3866 11 15.7324ZM16 8V7C16 4.79086 14.2091 3 12 3C9.79086 3 8 4.79086 8 7V8H16Z"></path></svg>
               </span>
               <input type="password" name="password" id="" class="form-control password" aria-describedby="phone"  value="">
            </div> --}}
                ...
                {{-- <p style="font-size: 0.9rem;">Forget Your Password? <a href="{{url('password/reset')}}">Reset Password</a></p> --}}
                ...
                <div>
                   <p style="font-size: 0.9rem; margin: 20px 0 0 0;">Don't have an account? <a href="{{url('register')}}">Register</a></p>
                </div> 
            </div>
