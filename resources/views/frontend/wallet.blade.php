         ...
         <div class="p-4 bg-light">
            <div class="wallet-card" style=" background-image: url({{url('assets/front/images/bg-image.jpg')}});">
               <div class="d-flex align-items-center">
                  <div class="mr-1"><img height="26px" width="26px" src="{{url('assets/front/images/global-rupeeIcon.png')}}" alt=""></div><span
                     class="text-white" style="font-size: 1.3em; font-weight: 900;">₹{{number_format(Auth::user()->deposit_amount,2)}}</span>
               </div>
            ...
            <div class="wallet-card" style="background-image: url({{url('assets/front/images/bg-image.jpg')}});">
               <div class="d-flex align-items-center">
                  <div class="mr-1"><img height="26px" width="26px" src="{{url('assets/front/images/global-rupeeIcon.png')}}" alt=""></div><span
                     class="text-white" style="font-size: 1.3em; font-weight: 900;">₹{{number_format(Auth::user()->wallet,2)}}</span>
               </div>
