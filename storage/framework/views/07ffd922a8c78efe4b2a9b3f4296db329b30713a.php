...
<!-- <div class="p-3" style="background: rgb(250, 250, 250);">
   <div class="center-xy py-2">
      <div><img class="border-50" height="80px" width="80px" src="<?php echo e(url('assets/front/images/author.svg')); ?>" alt=""></div>
      <div class="text-bold my-3">+91<?php echo e(Auth::user()->phone); ?> <small data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample"><img class="ml-2" width="20px" src="images/icon-edit.jpg"
               alt=""></small></div>
      ...
      <a class="d-flex align-items-center profile-wallet w-100" href="<?php echo e(url('wallet')); ?>">
         <div class="ml-4"><img width="32px" src="<?php echo e(url('assets/front/images/sidebar-wallet.png')); ?>" alt=""></div>
      ...
      <div class="react-swipeable-view-container ">
         <div>
            <a class="d-flex align-items-center profile-wallet bg-light mx-1 mt-3 py-3" href="#">
               <div class="ml-4"><img width="32px" src="<?php echo e(url('assets/front/images/kyc-icon-new.png')); ?>" alt=""></div>
         ...
         <div>
            <a class="d-flex align-items-center profile-wallet bg-light mx-1 my-3 py-3" href="#">
               <div class="ml-4"><img width="32px" src="<?php echo e(url('assets/front/images/mail.png')); ?>" alt=""></div>
   ...
   <div class="d-flex align-items-center position-relative" style="height: 84px;">
      <picture><img height="32px" width="32px" src="<?php echo e(url('assets/front/images/sidebar-referEarn.png')); ?>" alt=""></picture>
      <?php if(Auth::user()->refer_by): ?>
      <div class="pl-4">
         ...
         <div>
            <div class="MuiFormControl-root MuiTextField-root" style="vertical-align: bottom;">
               <div
                  ...
                  <span><?php echo e(Auth::user()->refer_by ?? ''); ?></span>
               </div>
            </div>
         </div>
      </div>
   ...
   <div class="px-3 py-1">
   <div class="d-flex align-items-center position-relative" style="height: 84px;">
      <picture><img height="32px" width="32px" src="<?php echo e(url('assets/front/images/global-cash-won-green-circular.png')); ?>" alt="">
      </picture>
      <div class="pl-4">
         <div class="text-uppercase moneyBox-header" style="font-size: 0.8em;">Cash Won</div>
         <div>
            <picture class="mr-1"><img height="auto" width="21px" src="<?php echo e(url('assets/front/images/global-rupeeIcon.png')); ?>" alt="">
            </picture>
            <span class="moneyBox-text" style="font-size: 1em; bottom: -1px;">₹<?php echo e(number_format(Auth::user()->wallet,2)); ?></span>
         </div>
   ...
   <div class="px-3 py-1">
   <div class="d-flex align-items-center position-relative" style="height: 84px;">
      <picture><img height="32px" width="32px" src="<?php echo e(url('assets/front/images/award-logo.png')); ?>" alt=""></picture>
      <div class="pl-4">
         <div class="text-uppercase moneyBox-header" style="font-size: 0.8em;">Battle Played</div>
         <div><span class="moneyBox-text" style="font-size: 1em; bottom: -1px;"><?php echo e($gameChallange ?? '0'); ?></span></div>
      </div>
   </div>
   </div>
   <div class="divider-x"></div>
...
<div class=" col-12 mx-auto p-3 g-0">
      ...
      <div class="card-body">
         <div class="avatar-upload">
            <div class="avatar-edit">
               <form action="<?php echo e(url('update-profile-img')); ?>" method="POST" id="update-profile" enctype="multipart/form-data">
                  <?php echo csrf_field(); ?>
            ...
            <div class="avatar-preview">
                <div id="imagePreview" style="background-image: url('<?php echo e(!empty(Auth::user()->profile_image) ? Auth::user()->profile_image : url('/assets/front/images/avatar.png')); ?>');">
                </div>
            </div>
        </div>
         ...
         <div class="d-flex flex-column align-items-start justify-content-center mb-3 mt-1">
            ...
            <div class="align-self-stretch d-flex align-items-center">
               <input type="text" class="form-control me-2 save_user_name_input" maxlength="15" value="<?php echo e(Auth::user()->name ?? ''); ?>">
         ...
         <div class="d-flex flex-column align-items-start justify-content-center mb-3">
            ...
            <div class="align-self-stretch"><input type="number" class="form-control" readonly="" disabled="" value="<?php echo e(Auth::user()->phone ?? ''); ?>"></div>
         </div>
            ...
            <div class="col-xl-6 col-lg-6 col-sm-6 col-12 mt-1 ">
               <div class="d-flex flex-column align-items-stretch justify-content-start h-100 w-100 card">
                  <div class="text-capitalize text-start px-2 card-header" style="font-size: 0.9rem;">
                     <div class="hstack gap-1"><img src="<?php echo e(url('assets/front/images/sword.9cc91e4925dc62491c20.webp')); ?>" width="16px"><span class="ml-1">games played</span>
                     </div>
                  </div>
                  <div class="fs-5 fw-semibold text-start py-1 px-2 card-body"><?php echo e($gameChallange ?? '0'); ?></div>
               </div>
            </div>
            <div class="col-xl-6 col-lg-6 col-sm-6 col-12 mt-1 ">
               <div class="d-flex flex-column align-items-stretch justify-content-start h-100 w-100 card">
                  ...
                  <div class="fs-5 fw-semibold text-start py-1 px-2 card-body">₹<?php echo e(number_format($amount,2)); ?></div>
               </div>
            </div>
         </div>
         <div class="g-0 gx-2 row">
            <div class="col-xl-6 col-lg-6 col-sm-6 col-12 mt-1 ">
               <div class="d-flex flex-column align-items-stretch justify-content-start h-100 w-100 card">
                  ...
                  <div class="fs-5 fw-semibold text-start py-1 px-2 card-body">₹<?php echo e(number_format($referAmout,2)); ?></div>
               </div>
            </div>
            <div class="col-xl-6 col-lg-6 col-sm-6 col-12 mt-1 ">
               <div class="d-flex flex-column align-items-stretch justify-content-start h-100 w-100 card">
   ...
   <div class="d-grid py-2">
      <a href="<?php echo e(url('logout')); ?>"> <button type="button" class="text-capitalize btn btn-outline-danger"style="margin-top: -19px;width:100%;">logout</button></a>
   </div>
</div>
<style>
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\LUDO\finalludo\resources\views/frontend/profile.blade.php ENDPATH**/ ?>