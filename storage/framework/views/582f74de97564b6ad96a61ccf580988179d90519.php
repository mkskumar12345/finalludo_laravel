      ...
      <div class="sideNav sidenav-custome">
         ...
         <div class="d-flex flex-column align-items-stretch justify-content-start p-0 offcanvas-body">
            <!-- <div class="d-flex align-items-center justify-content-between p-4">
               <div class="fs-1 fw-bold text-start d-flex align-items-center justify-content-start">
                  <div class="hstack gap-2">
                     <div class="m-0 me-1 d-flex align-items-center justify-content-start"><p class="m-0" style="font-size: 21px;">Hey,</p><p class="text-truncate m-0 me-2" style="max-width: 125px;">&nbsp;</p><img src="<?php echo e(url('assets/front/images/hand.webp')); ?>" alt="hello icon" width="36px" class="mr-2">
                        <p class="m-0 " style="font-size: 20px;" > <?php echo Str::limit(Auth::user()->name ?? '' , 10, ''); ?> </p>
                     </div>
                  </div>
               </div>
            </div> -->
            <div class=" d-flex flex-column align-items-stretch justify-content-start">
               ...
               <a class="text-start text-decoration-none bg-light p-3 text-dark fs-2 text-capitalize d-flex align-items-center justify-content-between" href="<?php echo e(url('home')); ?>">
                  <div class="d-flex align-items-center justify-content-start">
                     <div class="hstack gap-3">
                        <img src="<?php echo e(url('assets/front/images/play.2f22f88bac8acca85f6a.webp')); ?>"  class="mr-2" height="25px" alt="support icon">
               ...
               <?php endif; ?>
               <?php if(isset(Auth::user()->id)): ?>
               <a class="text-start text-decoration-none bg-light p-3 text-dark fs-2 text-capitalize d-flex align-items-center justify-content-between" href="<?php echo e(url('kyc')); ?>">
                  <div class="d-flex align-items-center justify-content-start">
                     <div class="hstack gap-3">
                        <img src="<?php echo e(url('assets/front/images/play.2f22f88bac8acca85f6a.webp')); ?>"  class="mr-2" height="25px" alt="support icon">
               ...
               <?php endif; ?>
               <?php if(isset(Auth::user()->id)): ?>
               <a class="text-start text-decoration-none bg-light p-3 text-dark fs-2 text-capitalize d-flex align-items-center justify-content-between" href="<?php echo e(url('profile')); ?>">
                  <div class="d-flex align-items-center justify-content-start">
                     <div class="hstack gap-3">
               ...
               <?php endif; ?>
               <?php if(isset(Auth::user()->id)): ?>
               <a class="text-start text-decoration-none bg-light p-3 text-dark fs-2 text-capitalize d-flex align-items-center justify-content-between" href="<?php echo e(url('wallet')); ?>">
                  <div class="d-flex align-items-center justify-content-start">
                     <div class="hstack gap-3">
               ...
               <?php endif; ?>
               <?php if(isset(Auth::user()->id)): ?>
               <a class="text-start text-decoration-none bg-light p-3 text-dark fs-2 text-capitalize d-flex align-items-center justify-content-between" href="<?php echo e(url('game-history')); ?>">
                  <div class="d-flex align-items-center justify-content-start">
                     <div class="hstack gap-3">
               ...
               <?php endif; ?>
               <?php if(isset(Auth::user()->id)): ?>
               <a class="text-start text-decoration-none bg-light p-3 text-dark fs-2 text-capitalize d-flex align-items-center justify-content-between" href="<?php echo e(url('transaction-history')); ?>">
                  <div class="d-flex align-items-center justify-content-start">
                     <div class="hstack gap-3">
                        <svg xmlns="http://www.w3.org/2000/svg"  class="mr-2" viewBox="0 0 16 16" class="mr-2" height="25px" fill="currentColor"><path d="M8.515 1.019A7 7 0 0 0 8 1V0a8 8 0 0 1 .589.022l-.074.997zm2.004.45a7.003 7.003 0 0 0-.985-.299l.219-.976c.383.086.76.2 1.126.342l-.36.933zm1.37.71a7.01 7.01 0 0 0-.439-.27l.493-.87a8.025 8.025 0 0 1 .979.654l-.615.789a6.996 6.996 0 0 0-.418-.302zm1.834 1.79a6.99 6.99 0 0 0-.653-.796l.724-.69c.27.285.52.59.747.91l-.818.576zm.744 1.352a7.08 7.08 0 0 0-.214-.468l.893-.45a7.976 7.976 0 0 1 .45 1.088l-.95.313a7.023 7.023 0 0 0-.179-.483zm.53 2.507a6.991 6.991 0 0 0-.1-1.025l.985-.17c.067.386.106.778.116 1.17l-1 .025zm-.131 1.538c.033-.17.06-.339.081-.51l.993.123a7.957 7.957 0 0 1-.23 1.155l-.964-.267c.046-.165.086-.332.12-.501zm-.952 2.379c.184-.29.346-.594.486-.908l.914.405c-.16.36-.345.706-.555 1.038l-.845-.535zm-.964 1.205c.122-.122.239-.248.35-.378l.758.653a8.073 8.073 0 0 1-.401.432l-.707-.707z"></path><path d="M8 1a7 7 0 1 0 4.95 11.95l.707.707A8.001 8.001 0 1 1 8 0v1z"></path><path d="M7.5 3a.5.5 0 0 1 .5.5v5.21l3.248 1.856a.5.5 0 0 1-.496.868l-3.5-2A.5.5 0 0 1 7 9V3.5a.5.5 0 0 1 .5-.5z"></path></svg>
               ...
               <a class="text-start text-decoration-none bg-light p-3 text-dark fs-2 text-capitalize d-flex align-items-center justify-content-between" href="<?php echo e(url('manual-transaction-history')); ?>">
                  <div class="d-flex align-items-center justify-content-start">
                     <div class="hstack gap-3">
                        <svg xmlns="http://www.w3.org/2000/svg"  class="mr-2" viewBox="0 0 16 16" class="mr-2" height="25px" fill="currentColor"><path d="M8.515 1.019A7 7 0 0 0 8 1V0a8 8 0 0 1 .589.022l-.074.997zm2.004.45a7.003 7.003 0 0 0-.985-.299l.219-.976c.383.086.76.2 1.126.342l-.36.933zm1.37.71a7.01 7.01 0 0 0-.439-.27l.493-.87a8.025 8.025 0 0 1 .979.654l-.615.789a6.996 6.996 0 0 0-.418-.302zm1.834 1.79a6.99 6.99 0 0 0-.653-.796l.724-.69c.27.285.52.59.747.91l-.818.576zm.744 1.352a7.08 7.08 0 0 0-.214-.468l.893-.45a7.976 7.976 0 0 1 .45 1.088l-.95.313a7.023 7.023 0 0 0-.179-.483zm.53 2.507a6.991 6.991 0 0 0-.1-1.025l.985-.17c.067.386.106.778.116 1.17l-1 .025zm-.131 1.538c.033-.17.06-.339.081-.51l.993.123a7.957 7.957 0 0 1-.23 1.155l-.964-.267c.046-.165.086-.332.12-.501zm-.952 2.379c.184-.29.346-.594.486-.908l.914.405c-.16.36-.345.706-.555 1.038l-.845-.535zm-.964 1.205c.122-.122.239-.248.35-.378l.758.653a8.073 8.073 0 0 1-.401.432l-.707-.707z"></path><path d="M8 1a7 7 0 1 0 4.95 11.95l.707.707A8.001 8.001 0 1 1 8 0v1z"></path><path d="M7.5 3a.5.5 0 0 1 .5.5v5.21l3.248 1.856a.5.5 0 0 1-.496.868l-3.5-2A.5.5 0 0 1 7 9V3.5a.5.5 0 0 1 .5-.5z"></path></svg>
               ...
               <a class="text-start text-decoration-none bg-light p-3 text-dark fs-2 text-capitalize d-flex align-items-center justify-content-between" href="<?php echo e(url('refer-earn')); ?>">
                  <div class="d-flex align-items-center justify-content-start">
                     <div class="hstack gap-3">
               ...
               <?php endif; ?>
               <a class="text-start text-decoration-none  bg-light  p-3 text-dark fs-2 text-capitalize d-flex align-items-center justify-content-between" href="<?php echo e(url('support')); ?>" style="margin: 0px 0px 67px 0px;">
                  <div class="d-flex align-items-center justify-content-start">
                     <div class="hstack gap-3">
                        <img src="<?php echo e(url('assets/front/images/chat-live.webp')); ?>"  class="mr-2" height="25px" alt="support icon">
         ...
         <!-- <a class="sideNav-options" href="<?php echo e(url('profile')); ?>">
            <div class="sideNav-icon"><img src="<?php echo e(url('assets/front/images/1.png')); ?>"></div>
         ...
         <a class="sideNav-options" href="<?php echo e(url('wallet')); ?>">
            <div class="sideNav-icon"><img style="width: 19px; height: 19px;" src="<?php echo e(url('assets/front/images/3.png')); ?>"></div>
            <div class="position-relative ml-3">
         ...
         <a class="sideNav-options" href="<?php echo e(url('game-history')); ?>">
            <div class="sideNav-icon"><img src="<?php echo e(url('assets/front/images/4.png')); ?>"></div>
            <div class="position-relative ml-3">
         ...
         <a class="sideNav-options" href="<?php echo e(url('transaction-history')); ?>">
            <div class="sideNav-icon"><img src="<?php echo e(url('assets/front/images/5.png')); ?>"></div>
            <div class="position-relative ml-3">
         ...
         <a class="sideNav-options" href="<?php echo e(url('refer-earn')); ?>">
            <div class="sideNav-icon"><img src="<?php echo e(url('assets/front/images/6.png')); ?>"></div>
            <div class="position-relative ml-3">
         ...
         <a class="sideNav-options" href="<?php echo e(url('notification')); ?>">
            <div class="sideNav-icon"><img src="<?php echo e(url('assets/front/images/7.png')); ?>"></div>
            <div class="position-relative ml-3">
         ...
         <a class="sideNav-options" href="<?php echo e(url('support')); ?>">
            <div class="sideNav-icon"><img src="<?php echo e(url('assets/front/images/8.png')); ?>"></div>
            <div class="position-relative ml-3">
...
p {
   ...
   </style><?php /**PATH D:\LUDO\finalludo\resources\views/partials/front-end/menu.blade.php ENDPATH**/ ?>