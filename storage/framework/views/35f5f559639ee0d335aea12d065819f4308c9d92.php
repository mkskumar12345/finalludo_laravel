...
<head>
    ...
    <link rel="icon" href="<?php echo e(url('/assets/logo/' . $logo ?? '')); ?>" />
    <title>
        <?php echo e(isset($settingData['site_title']) && !empty($settingData['site_title']) ? $settingData['site_title'] : 'Ludo'); ?>
    ...
    <link href="<?php echo e(url('assets/front/css/bootstrap.css')); ?>" rel="stylesheet">
    ...
    <link href="<?php echo e(url('assets/front/css/font.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(url('assets/front/css/bootstrap-side-modals.css')); ?>" rel="stylesheet">
    <script src="<?php echo e(url('assets/front/js/cdn.jsdelivr.net_npm_sweetalert2@11.js')); ?>"></script>
    <link rel="apple-touch-icon" href="<?php echo e(url('/assets/logo/' . $logo ?? '')); ?>">
...
<body>
    ...
    <?php echo $__env->make('partials.front-end.menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
">
    ...
    <div class="leftContainer ">
        <div class="headerContainer">
            ...
            <div class="sideNavIcon mr-2"><img src="<?php echo e(url('assets/front/images/nav-menu-icon.svg')); ?>" alt=""></div>
         </a> -->
            <a href="<?php echo e(url('home')); ?>">
                <div class="ml-2 navLogo d-flex"><img src="<?php echo e(url('/assets/logo/' . $logo ?? '')); ?>" alt="">
                </div>
            </a>
            <?php if(isset(Auth::user()->id)): ?>
                <div class="menu-items">
                    <div class="py-1 bg-white border px-2 text-dark d-flex align-items-center rounded-2"
                        ...
                        </svg><a href="<?php echo e(url('wallet')); ?>"><strong
                                style="text-decoration: none;color: #000000c2 !important;">
                                <?php echo e(number_format((Auth::user()->wallet ?? 0) + (Auth::user()->deposit_amount ?? 0), 2)); ?></strong></a>
                    </div>
                </div>
            <?php endif; ?>
        ...
        <div class="main-area" style="padding-top: 60px;">
            ...
            <!-- <?php echo $__env->make('partials.front-end.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> -->
        </div>
    </div>
    ...
    <div class="rightContainer">
        <div class="rcBanner flex-center">
            <div class="rcBanner-img-container"><img src="<?php echo e(url('/assets/logo/' . $logo ?? '')); ?>" alt="">
            </div>
            <div class="rcBanner-text"><?php echo e(env('SITE_NAME')); ?> <span class="rcBanner-text-bold">Win Real Cash!</span>
            </div>

        </div>
    </div>
    <script>
        var USERID = <?php echo e(Auth::user()->id ?? 'null'); ?>;
        // alert(USERID);
    </script>
    <!-- // console.log('USERID'+); -->
    ...
    <!--<script src="<?php echo e(url('assets/front/js/basic.js')); ?>"></script>-->
    ...
    <script>
        ...
        $('#addManualMoneyForm').on('submit', function (e) {
            ...
            $.ajax({
                url: "<?php echo e(url('add-money-manual')); ?>", // The URL to submit the form data to
                type: 'POST',
                data: formData,
...
<?php /**PATH D:\LUDO\finalludo\resources\views/layouts/frontend.blade.php ENDPATH**/ ?>