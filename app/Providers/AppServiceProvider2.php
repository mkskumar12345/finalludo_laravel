        ...
        View::composer('*', function($view){
             ...
             if(!$whataApp){
              ...
              $TransactionData = Transaction::where('transaction_type','withdrawal_money')->where('addition_status','pending')->get();
               $view->with(['ChallangeType' => $ChallangeType,'settingData' => $settingData,'telegram'=> $telegram,'whataApp' => $whataApp,'support_email'=>$support_email,'minDeposit' => $minDeposit , 'maxDeposit' => $maxDeposit , 'refer_amount' => $refer_amount,'permission' => $permission , 'TransactionData' => $TransactionData , 'logo' => $logo]);
